                                        ...
                                        <div class="icon">
                                            <div class="icon-inner">
                                                ...
                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    style="enable-background:new 0 0 308.728 308.728;"
                                                    xml:space="preserve">
                                                    <g>
                                                        <g>
                                        ...
                                        <div class="menu-menu-footer-company-container">
                                            <ul id="menu-menu-footer-company" class="menu">
                                                <li id="menu-item-813"
                                                    ...
                                                    <a href="category/thong-tin-nganh-hoc/dieu-duong/index.html">Điều
                                                        dưỡng</a>
                                                </li>
                                                <li id="menu-item-814"
                                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-814">
                                                    <a
                                                        href="category/thong-tin-nganh-hoc/cong-nghe-thong-tin/index.html">Công
                                                        nghệ thông tin</a>
                                                </li>
                                                <li id="menu-item-815"
                                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-815">
                                                    <a
                                                        href="category/thong-tin-nganh-hoc/nha-hang-khach-san/index.html">Nhà
                                                        hàng &#8211; Khách sạn</a>
                                                </li>
                                                <li id="menu-item-816"
                                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-816">
                                                    <a
                                                        href="category/thong-tin-nganh-hoc/co-khi-ky-thuat-oto/index.html">Cơ
                                                        khí &#8211; Kỹ thuật ôtô</a>
                                                </li>
                                                <li id="menu-item-817"
                                                    class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-817">
                                                    <a href="category/thong-tin-nganh-hoc/dau-bep/index.html">Đầu
                                                        bếp</a>
                                                </li>
                                            </ul>
                                        </div>
                        ...
                        <div class="col medium-6 small-12 large-3">
                            <div class="col-inner">
                                ...
                                <div role="form" class="wpcf7" id="wpcf7-f256-o1" lang="vi" dir="ltr">
                                    ...
                                    <form action="https://mauweb.monamedia.net/blueuni/#wpcf7-f256-o1" method="post"
                                        ...
                                        <p><span class="wpcf7-form-control-wrap email-dang-ky"><input type="email"
                                                    name="email-dang-ky" value="" size="40"
                                                    class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form_dang_ky"
                                                    id="email-dang-ky" aria-required="true" aria-invalid="false"
                                                    placeholder="Email ..." /></span><br />
                                            <label id="btn-gui-icon"><i class="fa fa-paper-plane"></i><input
                                                    type="submit" value="Gửi"
                                                    class="wpcf7-form-control wpcf7-submit form_dang_ky mona-hiden" /></label>
                                        </p>
