                  ...
                  <div class="card-body">
                    <form action="" @submit.prevent="onSubmit">
                      ...
                      <div class="form-group mt-3">
                        ...
                        <input type="number" v-model="form.credit" class="form-control" required min="0"
                          title="Tín chỉ phải là số không âm" />
                      </div>
                      <div class="form-group mt-3">
                        <label for="">Teacher</label>
                        <input type="text" v-model="form.teacher" class="form-control" required pattern="[a-zA-Z\s]*"
                          title="Giáo viên không được chứa ký tự đặc biệt hoặc số" />
                      </div>
                      <div class="form-group mt-3">
                        <label for="">Class</label>
                        <input type="text" v-model="form.className" class="form-control" required />
                      </div>
                      <div class="form-group mt-3">
                        <label for="">Date start</label>
                        <input type="date" v-model="form.dateStart" class="form-control" required />
                      </div>
                      <div class="form-group mt-3">
                        <label for="">Date end</label>
                        <input type="date" v-model="form.dateEnd" class="form-control" required :min="form.dateStart"
                  ...
                  <tbody>
                    <tr v-for="{
                      ...
                      <td>
                        ...
                        <button class="btn btn-primary btn-sm me-2" @click="deleteModule(id)">
                          Delete
                        </button>
                      </td>
                    </tr>
